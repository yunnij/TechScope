...
function buildPrompt(input: {
  ...
  return [
    ...
    "- `summary` should be 2-3 sentences and under 260 characters.",
    "- `whyItMatters` should be 1 sentence and under 180 characters.",
    "- `howItWorks` should be 1 sentence and under 180 characters.",
